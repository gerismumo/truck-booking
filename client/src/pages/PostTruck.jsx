...
import { useTrucksData } from './Trucks';
const PostTruck = () => {
const {trucksData} = useTrucksData();
  ...
  return (
    <>
    <DashHeader />
    <div className=" absolute mt-[100px] flex   justify-center px-[60px] w-[100%]">  
        <div className="flex justify-center items-center">
            <form onSubmit={(e) =>handleTruckAddition(e)} className='flex flex-col w-[500px] mt-[30px] mb-[70px] overflow-auto justify-center'>
